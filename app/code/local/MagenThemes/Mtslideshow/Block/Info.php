...
class MagenThemes_Mtslideshow_Block_Info extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    {
	$content = 'MT Slideshow version : 2.0.10<br/>Author : <a href="http://www.magentheme.com" title="Magento Themes">MagenTheme.Com</a><br />Copyright &copy; 2012- MagenTheme.Com';
	return $content;
    }
}