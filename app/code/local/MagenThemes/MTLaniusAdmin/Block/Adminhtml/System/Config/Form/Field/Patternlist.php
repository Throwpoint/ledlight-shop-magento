<?php
class MagenThemes_MTLaniusAdmin_Block_Adminhtml_System_Config_Form_Field_Patternlist extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element){ 
       	$html = parent::_getElementHtml($element);
		$directry = Mage::getBaseDir('skin').DS.'frontend'.DS.'default'.DS.'mt_lanius'.DS.'images'.DS.'pattern_body'; 
		...
		$html .='<div class="listpattern '.$element->getHtmlId().'_pattern">';
			$html .='<span class="item">
						...
						<input type="radio" name="pattern_body" value="none" style="margin-top: 7px;"/>
					 </span>';
			if($images){
				foreach ($images as $img){
			$html .='<span class="item">
						<img src="'.$urlparth.'/skin/frontend/default/mt_lanius/images/pattern_body/'.$img.'" />
