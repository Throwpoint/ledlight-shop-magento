...
(function($) {
    ...
    var NivoSlider = function(element, options){
		...
		slider.append('<div class="currentSlider"></div>');
        $('div.currentSlider', slider).html('<img src="'+ vars.currentImage.attr('src') +'"/>');
		...
		var nivoRun = function(slider, kids, settings, nudge){
			...
			if(!nudge){ 
				$('div.currentSlider', slider).html('<img src="'+ vars.currentImage.attr('src') +'"/>');
				$('div.currentSlider img', slider).animate({opacity:'0' }, settings.animSpeed);
			} else {
				if(nudge == 'prev'){
					$('div.currentSlider', slider).html('<img src="'+ vars.currentImage.attr('src') +'"/>');
					$('div.currentSlider img', slider).animate({opacity:'0' }, settings.animSpeed);
